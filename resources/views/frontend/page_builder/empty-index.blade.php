...
<head>
    ...
    <meta name="title" content="@if (!empty($page_builder->meta_title)) {{ $page_builder->meta_title }} @elseif (isset($seo)){{ $seo->meta_title }} @endif">
    ...
    <meta property="og:title" content="@if (!empty($page_builder->meta_title)) {{ $page_builder->meta_title }} @elseif (isset($seo)){{ $seo->meta_title }} @endif">
    ...
    <meta property="twitter:title" content="@if (!empty($page_builder->meta_title)) {{ $page_builder->meta_title }} @elseif (isset($seo)){{ $seo->meta_title }} @endif">
...
@include('frontend.sections.widget.fixed-button-style1')

<img src="{{ asset('uploads/img/dummy/create.webp') }}" alt="Snow" style="width:100%">
