                ...
                <section class="services-wrapper fix section-black section-padding">
                    <div class="container">
                        ...
                        @else
                            ...
                            @endif
                        @endisset
                        <div class="art-nice-icon d-none text-end d-lg-block wow fadeInDown" data-wow-duration="1.2s">
                            <img src="{{ asset('uploads/img/dummy/icons/art-nice.svg') }}" alt="icon image">
                        </div>
