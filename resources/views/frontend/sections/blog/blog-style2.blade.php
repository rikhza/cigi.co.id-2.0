                                    ...
                                    <div class="text-center mb-5 custom-category-link">
                                        ...
                                        @foreach ($blog_count_categories as $blog_count_category)
                                            @if (isset($blog_count_category->category->category_slug))
                                                <a class="link-secondary mb-2" href="{{ route('default-blog-category-index', $blog_count_category->category->category_slug) }}">{{$blog_count_category->category->category_name }} ({{ $blog_count_category->category_count }})</a>
                                            @endif
                                        @endforeach
