                                    ...
                                    <div class="text-center mb-5 custom-category-link">
                                        ...
                                        @foreach ($team_count_categories as $team_count_category)
                                            @if (isset($team_count_category->team_category->team_category_slug))
                                                <a class="mb-2" href="{{ route('default-team-category-index', $team_count_category->team_category->team_category_slug) }}">{{$team_count_category->team_category->category_name }} ({{ $team_count_category->category_count }})</a>
                                            @endif
                                        @endforeach
