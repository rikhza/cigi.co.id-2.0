        ...
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                <div class="d-md-flex justify-content-between align-items-center mb-20">
                    <h4 class="card-title">{{ __('content.edit_contact_info') }}
                        <!-- Button -->
            ...
            @if ($demo_mode == "on")
                ...
                @else
                    <form action="{{ route('contact-info.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        @endif
                        ...
                        <div class="row">
                                                        ...
                                                        <div class="media">
                                                            @if (!empty($item->section_image))
                                                                <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                                    <img src="{{ asset('uploads/img/contact_info/'.$item->section_image) }}" alt="image" class="rounded">
                                                                </a>
                                                            @else
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">{{ __('content.recommended_tags') }} <span class="text-danger font-weight-bold">{{ __('<span>, <br>, <a>') }}</span></small>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    @if ($demo_mode == "on")
                                        ...
                                        @include('admin.demo_mode.demo-mode')
                                    @else
                                        <form class="d-inline-block" action="{{ route('contact-info.destroy_image', $item->id) }}" method="POST">
                                            @method('DELETE')
                                            @csrf
                                            @endif
